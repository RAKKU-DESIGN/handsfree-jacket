...
ノートPCやケーブル類を全て収納可能なジャケット型バッグ。


## Description

ノートPCやケーブル類を全てポケットに収納可能なジャケット型バッグ。これを羽織ることでバッグやリュックが不要に。  
バッグ並みの収納力があるにも関わらず見た目はジャケットにしか見えないデザイン。
収納力が豊富にも関わらず、表はシンプルかつミニマルなデザインを実現。  
...
- 機能とデザインの両立：背中にノートPCを入れてもシルエットが崩れず、あくまでもジャケットにしか見えないデザインを実現。
...
- カフェで離席中のセキュリティ対策に：カフェでトイレに行く時のパソコン盗難防止として
- 空港で手荷物が重量オーバーした時に：手荷物が重量オーバーした時は重いものをポケットに移動して解決
- 手ぶらでテレワーク：仕事に必要な道具がすっぽり入るので、手ぶらでカフェやコワーキングスペースにお出かけ
- スーパー、コンビニで：うっかりエコバッグを忘れても、ちょっとした買い物であればレジ袋は必要ありません
